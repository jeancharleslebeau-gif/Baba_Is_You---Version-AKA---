/*
===============================================================================
  audio_player.cpp — Librairie audio générique (réutilisable)
-------------------------------------------------------------------------------
  Rôle :
  ...
  Notes :
    - Chaque type de piste (tone, noise, wav) est autonome.
    - Le moteur audio_player mixe plusieurs pistes en parallèle.
    - SAMPLE_RATE est défini localement (22050 Hz par défaut).
    - Le volume global est appliqué au mixage final.
    - Soft clipping limite la saturation.
...
// Constante locale de fréquence d’échantillonnage
static constexpr int SAMPLE_RATE = AUDIO_PLAYER_DEFAULT_SAMPLE_RATE;
